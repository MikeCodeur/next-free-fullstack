...
Par défaut, les composants `Next` sont des `RSC`, mais dans certains cas, nous avons **besoin** de composants `RCC`. Ce sont, par exemple, les composants qui nécessitent une interaction utilisateur.
